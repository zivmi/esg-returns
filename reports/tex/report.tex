...
% WRITE ABOUT THE DATA AND THEIR CLEANING

Simple linear regressions are performed where monthly returns are regressed on each factor. Based on that, we obtain plots displaying the intercept, coefficient and the t-statistic.\\ % Needs to be adjusted in python
...
\begin{thebibliography}{1} % Needs adjustment
